...
# source: Dataset_classification.proto
...
_DATA_HEADERS = _descriptor.Descriptor(
  name='Data_headers',
  full_name='Dataset_classification.Data_headers',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='image_width', full_name='Dataset_classification.Data_headers.image_width', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_height', full_name='Dataset_classification.Data_headers.image_height', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_depth', full_name='Dataset_classification.Data_headers.image_depth', index=2,
...
_IMAGE_SET = _descriptor.Descriptor(
  name='Image_set',
  full_name='Dataset_classification.Image_set',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='Image_headers', full_name='Dataset_classification.Image_set.Image_headers', index=0,
...
Image_set = _reflection.GeneratedProtocolMessageType('Image_set', (_message.Message,), dict(
  ...
  __module__ = 'Dataset_classification_pb2'
  # @@protoc_insertion_point(class_scope:Dataset_classification.Image_set)
  ))
